      ...
      <div class="col-md-8 col-md-offset-2">
        <div class="card">
          <div class="card-header banner">
            <h5 class="bannerFont"> Edit Gigs </h5>
          </div>
          ...
          <div class="card-body">
            ...
            @endif
            <form method="POST" action="{{ route('user.gigs.update', $gig->id) }}" enctype="multipart/form-data">
              ...
              <div class="float-right">
                <a href="{{ route('user.mygig.index') }}" class="btn btn-default">Cancel</a>
