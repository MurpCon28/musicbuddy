      ...
      <div class="col-md-12 col-md-offset-2">
        <div class="card">
          <div class="card-header banner">
            <h5 class="bannerFont">Gig: {{ $gigs->bandName }} <a href="https://www.ticketmaster.ie/" target="_blank" class="btn btn-primary float-right">Tickets</a></h5>
          </div>
                  ...
                  <div class="class-body">
                    ...
                    <a href="{{ route('admin.mygig.index') }}" class="btn btn-default">Back</a>
                    <a href="{{ route('admin.gigs.edit', $gigs->id) }}" class="btn btn-warning">Edit</a>
                    <form style="display:inline-block" method="POST" action="{{  route('admin.gigs.destroy', $gigs->id)  }}">
